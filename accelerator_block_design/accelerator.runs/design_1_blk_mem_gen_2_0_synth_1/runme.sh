...
HD_PWD='D:/code/accelerator/accelerator.runs/design_1_blk_mem_gen_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_blk_mem_gen_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_blk_mem_gen_2_0.tcl
